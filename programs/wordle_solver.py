...
def get_answer_arr():
    answers_arr = []
    with open('/Users/manitk/Desktop/Wordle/csv/valid_solutions.csv', mode='r') as answers_list:
...
def get_scores(arr):
    ...
    with open('/Users/manitk/Desktop/Wordle/csv/all_solns_scores.csv', mode='r') as scores_list:
    ...
    for word in answers_arr:
        if word not in guess_set:
            ...
            if count != len(total):
                ...
                guess_scores.pop(word)
    if(guesses>3):
        print("Remaining Guess List After Guess ",guesses," is - ",guess_scores)